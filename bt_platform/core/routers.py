...
from .endpoints import biotech, financial, market, analytics, search, news, insights, catalysts, competition, admin, loe, reports, evidence, therapeutic_areas, company_profile, science_events, catalysts_v2, ml_endpoints
...
api_router.include_router(
    ml_endpoints.router,
    tags=["machine-learning", "backtesting"]
)