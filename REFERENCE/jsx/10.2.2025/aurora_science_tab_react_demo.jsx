...
const MOCK_INDICATIONS = [
  {
    ...
    pipeline: [
      ...
      { name:"Ph1", progress:1 },
      { name:"Ph2", progress:.65 },
      { name:"Ph3", progress:.25 },
      { name:"Filed", progress:0 },
      { name:"Approved", progress:0 },
    ],
    refs:["doc-1","doc-2"],
    sponsors:[ { name:"AstraZeneca", type:"Big Pharma", exclusivityUntil:"2029-08-16" }, { name:"Spectrum Pharmaceuticals", type:"SMid", exclusivityUntil:"2030-04-01" } ],
  },
  {
    id:"ad-nflam",
    ...
    catalysts:[ { id:"3", label:"Biomarker Ph2", date:"2026-01-20", risk:"High", artStyle:"bar" } ],
    pipeline:[
      { name:"Preclinical", progress:1 }, { name:"Ph1", progress:1 }, { name:"Ph2", progress:.35 }, { name:"Ph3", progress:0 }, { name:"Filed", progress:0 }, { name:"Approved", progress:0 }
    ],
    refs:["doc-3"], sponsors:[ { name:"Eli Lilly", type:"Big Pharma", exclusivityUntil:"2031-05-10" } ],
  },
  {
    id:"dmd",
    name:"Duchenne Muscular Dystrophy (DMD)",
    area:"Rare / Neuromuscular",
    summary:"X-linked progressive muscle disease. Modalities include AAV gene therapy (microdystrophin), exon skipping, and antibody–oligo conjugates.",
    competitors:["Sarepta/Roche (Elevidys)","Regenxbio/AbbVie (RGX-202)","Solid Bio (SGT-003)"],
    tags:["AAV","microdystrophin","exon skipping"],
    catalysts:[ { id:"c1", label:"RGX-202 pivotal readout (est.)", date:"2026-06-30", risk:"Medium", artStyle:"ripple" } ],
  ...
  },
  {
    ...
    area:"Ophthalmology",
    summary:"Large but under‑treated population; efficacy proven with anti‑VEGF. Unlock hinges on lowering treatment burden.",
    ...
    catalysts:[ { id:"c2", label:"Ocular Tx Investor Day", date:"2025-09-30", risk:"Low", artStyle:"spark" } ],
